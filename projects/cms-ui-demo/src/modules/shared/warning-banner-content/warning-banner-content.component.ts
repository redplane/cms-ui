...
@Component({
  ...
  selector: 'warning-banner-content',
  templateUrl: './warning-banner-content.component.html',
  styleUrls: ['warning-banner-content.component.scss']
})
export class WarningBannerContentComponent implements IBannerContentComponent {
