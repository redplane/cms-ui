...
@Injectable()
export class UiModulePageGuard implements CanActivate {

  //#region Constructor

  public constructor(@Inject(MESSAGE_BUS_SERVICE_PROVIDER) protected readonly _messageBusService: INgRxMessageBusService) {
  }
  ...
  public canActivate(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<boolean | UrlTree> | Promise<boolean | UrlTree> | boolean | UrlTree {
    ...
    this._messageBusService.addTypedMessage(new DetailedUiModuleSelectedChannelEvent(), new DetailedUiModuleSelectedMessage(id))
    return of(true);
  }
